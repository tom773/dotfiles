...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/go.nvim",
    url = "https://github.com/ray-x/go.nvim"
  },
  ["guihua.lua"] = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/guihua.lua",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/tom/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-rest-console"] = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/vim-rest-console",
